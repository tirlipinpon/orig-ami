...
<div id="langues">
    ...
    <a class="selected" href="orig-ami-nl.php">Nl</a> |
...
<div id="container">
    ...
    <div id="content">
        <h1 id="firstHeading" class="firstHeading">Neederland</h1>
        <div id="bodyContent" class="media-belge">
            <!-- Médias Néerlandais (données dynamiques depuis Supabase) -->
            <?php foreach ($mediasNeerlandais as $media): ?>
...
// create email headers
    ...
    <p><strong>Bedankt dat je contact met ons hebt opgenomen.<br>We nemen spoedig contact met u op.</strong></p>
...
<div class="outer-flex-container displayNone">
    <div class="inner-flex-container">
        <div class="container">
            ...
            <form name="contactform"  onsubmit="if (verifiedCaptcha()!= true){  alert('Gelieve captcha te checken'); return false;}" method="POST" action="#contact">

                <input type="text" id="fna" name="fnal" placeholder="Jouw naam *" required>
                <input type="text" id="lna" name="lnal" placeholder="Jouw voornaam  *" required>
                <input type="text" id="lsoc" name="soca" placeholder="Naam van het bedrijf">
                <input type="text" id="lem" name="lema" placeholder="Uw e-mail *" required>
                <input type="text" id="lte" name="ltec" placeholder="Je telefoon">
                <textarea id="mras" name="ras" placeholder="Schrijf je bericht *" required style="height:100px"></textarea>
